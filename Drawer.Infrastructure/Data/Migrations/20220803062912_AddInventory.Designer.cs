...
namespace Drawer.Infrastructure.Data.Migrations
{
    ...
    [Migration("20220803062912_AddInventory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Drawer.Domain.Models.BasicInfo.Location", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Drawer.Domain.Models.BasicInfo.Location", b =>
                {
                    b.HasOne("Drawer.Domain.Models.BasicInfo.Location", "UpperLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("Drawer.Domain.Models.InventoryManagement.InventoryDetail", b =>
                {
                    b.HasOne("Drawer.Domain.Models.Items.Item", "Item")
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Drawer.Domain.Models.BasicInfo.Location", "Location")
                        .WithMany()
