...
PUBLISH_DIR=/home/ubuntu/drawer/api/publish
BLUE_DEPLOY_DIR=/home/ubuntu/drawer/api/blue
GREEN_DEPLOY_DIR=/home/ubuntu/drawer/api/green

BLUE_CONF=/etc/nginx/sites-available/drawer-api-blue.conf
GREEN_CONF=/etc/nginx/sites-available/drawer-api-green.conf
UPSTREAM_CONF=/etc/nginx/sites-enabled/drawer-api-upstream.conf
