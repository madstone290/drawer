#!/bin/bash
PUBLISH_DIR=drawer/api/publish # publish directory
BLUE_DIR=drawer/api/blue # blue deployment directory
GREEN_DIR=drawer/api/green # green deployment directory
